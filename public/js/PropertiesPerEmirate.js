...
},{"./Property":163,"react":159}],162:[function(require,module,exports){
'use strict';
...
var PropertiesPerEmirate = React.createClass({
	displayName: 'PropertiesPerEmirate',
	getInitialState: function getInitialState() {
		return {
			properties: []
		};
	...
	render: function render() {
		var emirates = ['dubai', 'abu-dhabi', 'al-ain', 'ajman', 'fujairah', 'ras-al-khaimah', 'sharjah', 'umm-al-quwain'];
		...
		var propertiesPerCities = emirates.map(function (emirate) {
			...
			return React.createElement(
				'div',
				{ key: emirate, className: 'City col-md-12' },
				React.createElement(
					'h2',
					null,
					emirate
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'City__gallery col-md-8' },
						React.createElement(
							'div',
							null,
							React.createElement('img', { src: 'http://lorempixel.com/1300/800/city',
					...
					React.createElement(
						'div',
						{ className: 'City__why-visit col-md-4' },
						React.createElement(_WhyVisit2.default, { emirate: emirate })
					)
				),
				React.createElement(
					'div',
					...
					React.createElement(
						'div',
						{ className: 'City__available-in col-md-12' },
						React.createElement(
							'h4',
							null,
							'Available in ',
						...
						React.createElement(_Properties2.default, { url: cityUrl })
					)
				),
				React.createElement(
					'div',
...
ReactDOM.render(React.createElement(PropertiesPerEmirate, null), document.getElementById('PropertiesPerEmirate'));

},{"./Properties":161,"./WhyVisit":164,"react":159,"react-dom":30}],163:[function(require,module,exports){
'use strict';
...
},{"./Gallery":160,"classnames":1,"react":159}],164:[function(require,module,exports){
'use strict';
...
//# sourceMappingURL=PropertiesPerEmirate.js.map
